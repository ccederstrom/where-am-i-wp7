...
using ScheduledTaskAgent1.Util;
...
namespace ScheduledTaskAgent1
{
    public class ScheduledAgent : ScheduledTaskAgent
    {
        ...
        {
            Debug.WriteLine("Start PeriodicTask");
            //Live Tile !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            int newCount = 99;
            ...
            if (task is PeriodicTask)
            {
                ...
                Address.ReverseGeocodeAddress(
                         ...
                         Constants._credentialsProvider,
                         watcher.Position.Location,
                         result => address = result.Address.FormattedAddress.ToString());
                Debug.WriteLine("addres is " + Address.CurrentAddress);
